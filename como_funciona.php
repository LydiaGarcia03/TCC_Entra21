...
<head>
	<meta charset="utf-8">
	<title>ComfyCare | Como Funciona</title>
	<!-- CSS | Bootstrap -->
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark text-white m-0 py-4">
		<div class="container-fluid">
			<a href="index.php"><p class="font-weight-light text-decoration-none text-white h4">ComfyCare</p></a>
			<div class="container">
				<div class="row">
					<div class="col-10 col-sm-9 offset-md-3 text-right">
						<ul class="navbar-nav float-left pt-1">
							...
							<li class="nav-item active mr-5 mr-sm-4"><a href="como_funciona.php" class="nav-link p-0">Como funciona</a></li>
