...
<head>
	<meta charset="utf-8">
	<title>ComfyCare | Sobre nós</title>
	<!-- CSS | Bootstrap -->
...
<body style="background-color: rgba(15, 116, 163, 0.1)">
	...
	<img id="imagem" src="Penguins.jpg" width="1263" height="500">
	<div class="container-fluid">
		<div class="container">
			<div class="row">
				<div class="col-12 mt-3 mb-3">
					<h1 id="texto">Sobre nós</h1>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="col-12">	
					<div class="card mb-3">
						<div class="row no-gutters">
							<div class="col-md-4">
								<img src="img/blablabla.png" class="card-img" alt="...">
							</div>
							<div class="col-md-8">
								<div class="card-body">
