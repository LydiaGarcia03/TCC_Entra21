			...
			<div class="row">
				<div class="col-12">							
					...
					<div class="row no-gutters">
						<div class="col-4">
							<img src="img/blablabla.png" height="274" width="351">
						</div>
						<div class="col-8 text-justify my-auto" style="font-size: 3;">
							<p class="h5">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
					...
					<div class="row no-gutters">
						...
						<div class="col-4">
							<img src="img/boxhome2.jpg" height="274" width="351" style="float: right;">
						</div>
					</div>
					<div class="row no-gutters">
						<div class="col-4 mb-4">
							<img src="img/file.jpg" height="274" width="351">
						</div>
						<div class="col-8 mb-4 text-justify my-auto">
							<p class="h5">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
								tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
								quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
								consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
