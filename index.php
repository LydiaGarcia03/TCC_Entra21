...
<body class="bg-light">
    ...
    <section class="m-5" id="como-funcionar">
        <div class="container text-center bg-white">
                        ...
                        <div class="tab-pane fade" id="nav-item-02" role="tabpanel">
                            <div class="row">
                                <div class="col-sm-6 mb-5">
                                    <div>
                                        <i class="fas fa-users fa-4x mb-2 text-primary"></i>
                                        <h4>1. Cadastro</h4>
                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                    </div>
                                </div>
                                <div class="col-sm-6 mb-5 mt-4 mt-md-0">
                                    <i class="fas fa-search fa-4x mb-2 text-primary"></i>
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-4">
                                    <div>
                                        <i class="fas fa-thumbs-up fa-4x mb-2 text-primary"></i>
