        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSite">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a href="#como-funcionar" class="nav-link">COMO FUNCIONA</a>
                    </li>
                    <li class="nav-item active">
    ...
    <div id="carouselsite" class="carousel slide " data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block text-right pr-5">
                    <h2>Apenas profissionais</h2>
                    <p>O sistema permite somente o cadastro de profissionais de saúde com identificações</p>
                </div>
            </div>
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block text-right pr-5">
                    <h2>Plataforma para contratação</h2>
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-4">
                                    <div class="">
                                        ...
                                        <h4>1. Cadastro</h4>
                                        <p class="mb-5">Crie uma conta, rápido e simples.</p>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-4">
                                    <div class="">
                                        ...
                                        <p class="mb-5">Escolha o tipo de atendimento que precisa, preencha o CEP do local do atendimento,
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-5">
                                    <div>
                                        <i class="fas fa-users fa-4x mb-2 text-primary mb-3 mt-5"></i>
                                        <h4>1. Cadastro</h4>
                                        <p>Crie uma conta, rápido e simples.</p>
                                    </div>
                                </div>
                                <div class="col-sm-6 mb-5 mt-4 mt-md-0">
                                    <i class="fas fa-search fa-4x mb-2 text-primary mb-3 mt-5"></i>
                                    <h4>2. Análise de documentos</h4>
                                    <p>A equipe da Home Care Digital analisa cuidadosamente os dados informados por você.</p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-4">
                                    <div>
                                        ...
                                        <p>Depois de análise de dados, os clientes passam a ter acesso ao seu perfil.</p>
                                    </div>
                                </div>
                                <div class="col-sm-6 mb-4  mt-md-0 ">
                                    <i class="far fa-address-book fa-4x mb-3 text-primary mt-5"></i>
                                    <h4>4. Solicitação de serviço</h4>
                                    <p>O cliente entra em contato com o profissional, organiza as condições do trabalho e agenda o atendimento.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="faq" id="accordion">
                        <div class="card">
                            <div class="card-header bg-primary" id="faqHeading-5">
                                <div class="mb-0">
                                    <h5 class="faq-title text-white" data-toggle="collapse" data-target="#faqCollapse-5" data-aria-expanded="true" data-aria-controls="faqCollapse-5">
                        ...
                        <div class="card">
                            <div class="card-header bg-primary" id="faqHeading-6">
                                <div class="mb-0">
                                    <h5 class="faq-title text-white" data-toggle="collapse" data-target="#faqCollapse-6" data-aria-expanded="false" data-aria-controls="faqCollapse-6">
                                        <span class="badge">6</span> O que acontecerá depois do cadastro efetuado?
                                    </h5>
                                </div>
                            </div>
                            ...
                            <div class="card-header bg-primary" id="faqHeading-7">
                                <div class="mb-0">
                                    <h5 class="faq-title text-white" data-toggle="collapse" data-target="#faqCollapse-7" data-aria-expanded="false" data-aria-controls="faqCollapse-7">
                                        <span class="badge">7</span>Quanto tempo leva até a ativação do cadastro?
                                    </h5>
                                </div>
                            </div>
                            <div id="faqCollapse-7" class="collapse" aria-labelledby="faqHeading-7" data-parent="#accordion">
                                <div class="card-body">
                                    <p>A ativação do cadastro poderá ocorrer em até 48 horas.</p>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-header bg-primary" id="faqHeading-8">
                                <div class="mb-0">
                                    <h5 class="faq-title text-white" data-toggle="collapse" data-target="#faqCollapse-8" data-aria-expanded="false" data-aria-controls="faqCollapse-8">
                                        <span class="badge">8</span>Pode-se entrar em contato com o solicitante?
                                    </h5>
                                </div>
                            </div>
                            <div id="faqCollapse-8" class="collapse" aria-labelledby="faqHeading-8" data-parent="#accordion">
                                <div class="card-body">
                                    <p>Sim. O profissional receberá o telefone de contato do solicitante e, caso seja necessário, poderá entrar em contato.</p>
                                </div>
                            </div>
                        </div>
