...
<head>
	...
	<!-- Favicon-->
	<link rel="shortcut icon" href="img/senior-03.jpg">
	<!-- Author Meta -->
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-6 header-top-right no-padding">
							<ul>
								<li><a href="tel:+440 012 3654 896"><span class="lnr lnr-phone-handset"></span><span>+55 (47)9 995847518</span></a></li>
								<li><a href="mailto:support@colorlib.com"><span class="lnr lnr-envelope"></span><span>support@hotmail.com</span></a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="row small-gutters">
							<div class="col-lg-8 top-post-left">
								<div class="feature-image-thumb relative">
									...
									<img class="img-fluid" src="img/senior-03.jpg" alt="">
								</div>
								<div class="top-post-details">
									<ul class="tags">
										<li><a href="#">Habitos alimentares</a></li>
									</ul>
									...
									<ul class="meta">
										...
										<li><a href="#"><span class="lnr lnr-calendar-full"></span>03 abril, 2019</a></li>
										<li><a href="#"><span class="lnr lnr-bubble"></span>06 Comentarios</a></li>
									</ul>
								</div>
							</div>
							...
							<div class="col-lg-12">
								<div class="news-tracker-wrap">
									<h6><span>Ultima noticia:</span>   <a href="#">O meteoro chegou</a></h6>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-lg-8 post-list">
								...
								<div class="latest-post-wrap">
									<h4 class="cat-title">Ultimas noticias</h4>
								...
								<div class="popular-post-wrap">
									<h4 class="title">Post populares</h4>
							...
							<div class="col-lg-4">
								<div class="sidebars-area">
									...
									<div class="single-sidebar-widget most-popular-widget">
										<h6 class="title">Mais popular</h6>
									...
									<div class="single-sidebar-widget social-network-widget">
										<h6 class="title">Midia social</h6>
