                            ...
                            <div class="card my-5 rounded-0">
                                <div class="card-body float-left">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <p class="card-text m-0 campo"><?=(count($servicos->buscarCuidadorPorServico($servico['id_servico'])) > 0) ? $servicos->buscarCuidadorPorServico($servico['id_servico']) : 'Nenhum cuidador'?></p>
                        ...
                        <?php if (count($lista) <= 0) : ?>
                            <div class="card rounded-0">
                                <div class="card-body text-center py-5 shadow">
                                    ...
                                    <br>
                                    <a href="solicitar_servico.php" class="btn btn-primary mt-3 shadow">
